...
async function Footer() {
  ...
  const socailLink = [
    {
      icon: <FaGithub />,
      link: "https://github.com/vikashalex"
    },
    {
      icon: <FaFacebook />,
      link: "https://www.facebook.com/vikash.alex.14942/"
    },
    {
      icon: <FaInstagram />,
      link: "https://www.instagram.com/heart_less_637/"
    },
    {
      icon: <FaLinkedin />,
      link: "https://www.linkedin.com/in/vikash-kumar-75a507288/"
    },
        ...
        <div className="flex-1">
          ...
          <div>
            ...
            <div className="my-3 text-sm sm:text-base">
              <p>257 Malakhera, Road, Alwar, 301001</p>
              <p>vkumar637525@gmail.com</p>
            </div>
